...
-- 4. Finální SELECT: Zobrazí všechny sloupce a přidá nový pro rozdíl v růstu
SELECT
    *,
    (yearly_price_growth_percent - yearly_payroll_growth_percent) AS growth_difference_percentage
FROM yearly_growth
ORDER BY year;